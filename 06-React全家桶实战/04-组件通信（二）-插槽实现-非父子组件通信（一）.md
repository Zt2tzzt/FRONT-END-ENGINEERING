...
> - imd - ES6 模块化导入；imp - ES6 模块化导入，默认导入；exp - ES6 模块化导出，默认导出
...
03-learn-component\src\06-组件通信案例联系TabControl\App.jsx
...
使用场景：没有作为 Context.Provider 的后代元素，但仍然想用 Context 共享的数据。
